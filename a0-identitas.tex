...
\providecommand{\judulid}{Rancang Bangun Sistem Navigasi Otonom Pada Robot Semprot Pestisida menggunakan YOLOv8 dan Fuzzy Logic Controller} %Judul Tugas Akhir Bahasa Indonesia
\providecommand{\judulen}{"Design and Development of an Autonomous Navigation System for Pesticide Spraying Robots Using YOLOv8 and Fuzzy Logic Controller"} %Judul Tugas Akhir Bahasa Inggirs
\providecommand{\penulis}{Lukman Pambudi} %Nama Lengkap Mahasiswa 
\providecommand{\nim}{20507334062} % NIM
...
\providecommand{\tglpersetujuan}{3 Juli 2024} %Tanggal di Lembar Persetujuan
